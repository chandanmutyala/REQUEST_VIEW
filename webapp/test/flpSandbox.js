		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comrequestviewrequestview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrequestviewrequestview-display": {
								"semanticObject": "comrequestviewrequestview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.requestview.requestview",
									"url": sap.ui.require.toUrl("com/requestview/requestview")
								}
							}
						}
					}
